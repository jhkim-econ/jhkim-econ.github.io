---
title: '2025 Budget Review: Loan Support and Interest Subsidy Programs under Public Financing'
date: 2024-09-02
...
> 📄 *This document is an English translation of the official 2025 Budget Review on public financing programs.*

---

## 1. Overview of Public Financing Programs
...
## 2. FY2023 Public Financing Budget Execution by Ministry
...
## 3. Expenditure Trends by Support Type (2019–2023)
...
> 📄 *The following section on "Policy Implications of the Government’s Preference for Interest Subsidies over Direct Loans" presents the analysis authored by Junghwan Kim (na32@assembly.go.kr).*
...
### 1. Loan and Interest Subsidy Programs

#### (a) Need to Assess the Effectiveness of Loan and Interest Subsidy Programs
...
##### (1) Need to Avoid Interest Subsidy Allocations That Exceed Budgeted Amounts
...
##### (2) Cases of Interest Subsidy Execution Beyond Approved Budget
...
Originally allocated ₩451.9 billion in 2023, with ₩4.8 billion reallocated for disaster recovery, only ₩416.7 billion was disbursed due to revenue shortfalls in the Agricultural Structure Improvement Fund. However, subsidy obligations to the National Agricultural Cooperative Federation (NACF) reached ₩578.7 billion—₩162 billion more than disbursed.
...
The ministry attributed this gap to interest rate hikes post-budget approval. However, this resulted in an additional ₩162 billion in carryover obligations to 2024, accounting for 32.2% of the non-earmarked 2024 budget—a significant fiscal risk. Executing beyond legislative limits undermines fiscal discipline and transparency.

**Example 2: Forest Management Composite Fund Interest Subsidy**  
The **Korea Forest Service** provided interest subsidies to forestry producers for short-term income stabilization. Although ₩9.5 billion was budgeted in 2023, actual obligations reached ₩11 billion.
...
Again, subsidies were executed beyond the budget authorized by the National Assembly, raising concerns over unchecked fiscal risk and governance loopholes.

---

##### (3) Need for Oversight by Type of Interest Subsidy Support

Government-led interest subsidy programs can be classified into:

- **Actual Cost Reimbursement:** Support based on the exact interest gap incurred by financial institutions.
- **Lump-sum (Estimated Average) Support:** Support calculated in advance based on the average loan balance and a fixed interest subsidy rate.

From the recipient's perspective, these schemes fall under:

- **Floating Subsidy Type:** Fixed target rate; the subsidy rate varies per loan.
- **Fixed Subsidy Type:** Fixed subsidy rate; actual interest paid by borrowers varies.

| Category | Financial Institution Perspective | Recipient Perspective |
|----------|-------------------------|--------------------------|
|          | Actual Cost Reimbursement | Lump-Sum Support         |
| Floating Subsidy | Small Business Interest Subsidy (FSC) | Hope Plus Interest Subsidy (FSC) |
| Fixed Subsidy   | Agricultural Loan Interest Subsidy (MAFRA), Housing Loan Interest Subsidy (MOLIT) | N/A |

**Note:** When subsidy rates are fixed, payments are based on average loan balances × subsidy rate — thus incompatible with lump-sum disbursements.
...
| Program Category | Low-Income Small Biz Interest Subsidy | Hope Plus Interest Subsidy (2nd Reform) |
|------------------|----------------------------------------|-----------------------------------------|
| Initial Phase    | 1st Extension | 2nd Extension |
| **Eligibility** | High-credit small business owners with annual revenue ≤ KRW 500 million directly or indirectly impacted by COVID-19 | All small business owners already participating in the low-income interest subsidy program | Recipients of quarantine or loss compensation aid among high-credit small business owners |
| **Loan Type** | New unsecured loans for working capital offered by commercial banks | Credit loans or refinancing loans offered by commercial banks |
| **Loan Limit** | KRW 30 million per company | – | – | KRW 30 million |
| **Subsidy Structure** | Ultra-low interest loan (1.5%); 80% of the interest gap (loan rate – 1.5%) subsidized | Ultra-low interest loan (1.5%); 70% of gap subsidized | Ultra-low interest loan (2.5%); 70% of gap subsidized |
| **Average Rate Comparison** | 6.3% avg. market rate – 3.3% applied = 2.1% gap | Uniform 2.1% gap used for all banks |
| **Bank Cost-Sharing Rate** | 20% | 30% | 30% | 30% |
| **Support Period** | 1 year | 1 year | 1 year | 2 years |
| **Operation Period** | Apr 1, 2020 – Dec 31, 2021 | Apr 1, 2021 – Dec 31, 2022 | Apr 1, 2022 – Dec 31, 2023 | From Jan 24, 2022 until funds are exhausted |
| **Total Budget Cap** | KRW 3.5 trillion | – | – | KRW 2.4 trillion |
| **Subsidy Allocation** | KRW 60.375 billion | KRW 48.418 billion | KRW 34.152 billion | KRW 100 billion |

_Source: Financial Services Commission_  
_[2023 Summary of Interest Subsidy Programs for Small Businesses]_

---

For the Low-Income Small Business Interest Subsidy program, a **target interest rate of 2.5%** is fixed. The government then calculates and reimburses the **difference between the actual loan rate and this target** per loan.

#### 📊 Financial Institution-Level Breakdown of Support Amounts
...
| FSC (KODIT) | | | Gyeongnam Bank | 60,671 | 1.27% | 282.80 | 597 |
...
_Source: Financial Services Commission_  
_[2023 Subsidy Disbursements by Bank under the Low-Income Small Business Interest Subsidy Program]_

---

This reimbursement-linked model introduces **moral hazard** risks compared to schemes with a **uniform fixed subsidy rate**, for the following reasons:

1. **From the borrower’s perspective**: Since the final loan rate is fixed at 2.5%, regardless of the original rate, there’s no incentive to negotiate a lower rate before applying for the subsidy.
2. **From the lender’s perspective**: Since the government compensates the gap between their set rate and 2.5%, banks can increase their pre-subsidy loan rates to maximize the reimbursement amount without concern for competitive pressure.
...
_Source: Financial Services Commission_  
_[2023 Avg Lending Rates by Bank under the Interest Subsidy Program]_
...
#### 📋 Hope Plus Program Design Timeline
...
_Source: Financial Services Commission_  
_[Overview of the Hope Plus Interest Subsidy Program]_
...
#### 📊 Bank-Level Lump-Sum Subsidy Payments (2023)
...
_Source: Financial Services Commission_  
_[Interest Subsidy Disbursements by Bank under the Hope Plus Program (2023)]_
...
> – High-credit borrowers who received either COVID-19 relief or loss compensation payments  
> – High-credit recipients of the Low-Income Interest Subsidy Program  
> \* As defined by the Ministry of SMEs and Startups: individual credit score ≥ 920 (NICE)  
> \* Income threshold: ≤ KRW 500 million annually  
> \* High credit grade: 1–3

_Source: Financial Services Commission_  
_[Eligibility Framework for Hope Plus Interest Subsidy Program]_
...
#### (b) Need for Strengthening the Management and Operational Framework for Loan and Interest Subsidy Programs

##### 1. Establishing a Proper System for Disbursing Management Fees to Implementing Agencies
...
### 📊 Examples of Dedicated Project Budgets for Managing Loan and Subsidy Programs (Unit: ₩ million)
...
> **[Table: Examples of Dedicated Budget Allocations for Public Agency Loan/Subsidy Management]**
...
####### 📊 Examples: Use of Loan Repayments for Project Management Costs (Unit: ₩ million)
...
> **[Table: 2023 Cases Where Public Agencies Used Loan Repayments Directly as Management Costs]**
...
####### 📊 Examples: Use of Interest Subsidy Funds for Admin Costs (Unit: ₩ million)
...
> **[Table: 2023 Cases Where Interest Subsidy Funds Were Used for Project Management]**
...
##### 2. Need to Establish Oversight for the Direct Use of Project Revenue

###### Improper Delegation of Fund Management in the ICT Loan Support Program
...
This program provides low-income persons with disabilities with self-reliance funds to support livelihood and stability. The loan handling fee rate is set at 1.5%.
...
Third, due to the absence of clear settlement guidelines for interest subsidy funds, interest income generated from delayed disbursement of these funds is not being returned to the treasury. The Ministry of Trade, Industry and Energy (MOTIE) should consider institutional improvements by establishing rules for settling unused balances and interest income, and by ensuring the return of such income to the national treasury.
...
#### (c) Assessment of Fiscal Soundness and Transparency in Loan and Interest Subsidy Programs
...
**Second**, the Korea Mine Rehabilitation and Mineral Resources Corporation (KOMIR) has carried out loan support projects using contributions for deficit compensation through 2023. However, since KOMIR was de-designated as a deficit-compensation institution starting in 2024, it is now expected to operate the loan fund using its own surplus resources. Accordingly, it is necessary to ensure a level of transparency equivalent to that of budgetary revenue and expenditure.
...
#### <Loan Execution and Repayment Performance, 2021–2023>
...
_Source: Ministry of Trade, Industry and Energy_  
_[Performance of the Substitution Industry Loan Program at KOMIR, 2021–2023]_
...
###### Issue: Agricultural Land Management Fund
...
###### Case of the Private School Promotion Fund – Happy Dormitory Support Program
