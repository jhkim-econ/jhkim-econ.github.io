...
> 📄 *This document is an English translation of the official 2023 Program Implementation Review on Policy Implications of the Government's Preference for Interest Subsidies over Direct Loans, published by the Special Committee on Budget and Accounts.*

---

# 1. Introduction

## (a) Overview of Public Financing Programs
...
## (b) FY2023 Public Financing Budget Execution by Ministry
...
## (c) Expenditure Trends by Support Type (2019–2023)
...
## (a) On Loan and Interest Subsidy Program Structures
...
| **Recipient Perspective**       | **Subsidy Model**         | **Financial Institution Perspective** <br> *(Actual Cost Reimbursement)* | **Financial Institution Perspective** <br> *(Estimated Lump-Sum Payment)* |
|--------------------------------|---------------------------|---------------------------------------------------------------------------|------------------------------------------------------------------------------|
|                                | **Floating Subsidy Model** | *Small Business Interest Subsidy (FSC)*                                   | *Hope Plus Interest Subsidy (FSC)*                                          |
...
In the case of the **Interest Subsidy Program for Micro Business Owners**, the **target interest rate is fixed at 2.5 percent**, and the interest subsidy amount is calculated as the difference between the **actual loan interest rate** and the **target rate**, on a loan-by-loan basis.
...
Support schemes like the **Interest Subsidy Program for Micro Business Owners**, in which the **interest subsidy is linked to a fixed target rate (2.5%) on a per-loan basis**, may give rise to **moral hazard** when compared to models that apply a **uniform, pre-fixed subsidy rate** across all loans. This is because;
...
## (b) On Need for Strengthening the Management and Operational Framework for Loan and Interest Subsidy Programs
